...
links:
  - https://github.com/typst/typst/pull/5753
  - https://github.com/typst/typst/issues/5760
---
...
这是一个被官方开发者承认的 Bug，并且需要注意的是，它可能看起来无关紧要，但是实际上有很大的造成误解的风险。例如，对于这种情况，这个特性就是无害的：
