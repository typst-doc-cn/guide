...
- 如想复现例子，请[安装 Source Han Serif SC 字体](https://typst-doc-cn.github.io/guide/FAQ/install-fonts.html#简单需求)；如想完全复现，可参考[`download-fonts.sh`](./scripts/download-fonts.sh)。
